...
public class GameOverC : MonoBehaviour {
	...
	void OnGUI(){
		if(menu){
			...
			GUI.Box(new Rect(Screen.width /2 -100,Screen.height /2 -120,200,160), "复活面板");
			if(GUI.Button(new Rect(Screen.width /2 -80,Screen.height /2 -80,160,40), "复活")) {
				LoadData();
			}
			if(GUI.Button(new Rect(Screen.width /2 -80,Screen.height /2 -20,160,40), "回到标题")) {
