...
public class BulletStatusC : MonoBehaviour {
	...
	void OnTriggerEnter(Collider other){  	
		...
		if(shooterTag == "Player" && other.tag == "Enemy"){	  
			...
			dmgPop.GetComponent<DamagePopupC>().fontStyle.fontSize = 50;
			...
			dmgPop.GetComponent<DamagePopupC>().damage = popDamage;
			dmgPop.GetComponent<DamagePopupC>().fontStyle.fontSize = 20;
			dmgPop.GetComponent<DamagePopupC>().fontStyle.normal.textColor = Color.white;
